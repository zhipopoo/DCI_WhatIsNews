-- ============================================================
-- WhatIsNews — Database Initialization Script
-- ============================================================
-- Usage (Docker):
--   docker compose exec postgres psql -U whatisnews -d whatisnews -f /tmp/init.sql
--
-- Usage (Local):
--   psql -U whatisnews -d whatisnews -f database/init.sql
-- ============================================================
...
-- ============================================================
-- Seed Data — 8 Demo News Articles
-- ============================================================

-- #1: Top / Sticky — DCI Cloud Service
...
<p>The platform is available starting today for all DCI Cloud Service customers.</p>',
    'https://images.unsplash.com/photo-1451187580459-43490279c0fa?w=800',
    1, 'Cloud,DCI,Infrastructure,AI', 'Michael Chen', TRUE, TRUE, 1520, '2026-05-28 09:00:00'
);

-- #2: Top / Sticky — AI & AI Models
INSERT INTO news (title, subtitle, summary, content, cover_image, category_id, tags, author, is_published, is_top, view_count, published_at) VALUES (
...
<p>OpenAI has released preliminary benchmarks for GPT-5, its upcoming next-generation language model. The results show substantial improvements across multiple dimensions.</p>
...
<p>Industry analysts predict GPT-5 will transform software development, scientific research, and content creation.</p>',
    'https://images.unsplash.com/photo-1677442136019-21780ecad995?w=800',
    2, 'AI,GPT-5,OpenAI,LLM', 'Sarah Johnson', TRUE, TRUE, 2340, '2026-05-27 14:30:00'
);

-- #3: Top / Sticky — AI Tools
INSERT INTO news (title, subtitle, summary, content, cover_image, category_id, tags, author, is_published, is_top, view_count, published_at) VALUES (
...
<p>Anthropic''s Claude Code has emerged as one of the most powerful AI-assisted development tools. Running directly in the terminal, it provides developers with an intelligent assistant that understands codebases and manages complex tasks.</p>
...
<blockquote>Claude Code has reduced our development cycle by 40%. It''s not just a copilot—it''s a full development partner.</blockquote>',
    ...
    3, 'Claude,Anthropic,Developer Tools,AI', 'David Kim', TRUE, TRUE, 1890, '2026-05-26 11:00:00'
);
...
<li><strong>Simplified UX:</strong> New declarative config format reducing YAML complexity by 60%</li>
<li><strong>Enhanced Security:</strong> Built-in supply chain security with SBOM integration</li>
</ul>
<p>The WebAssembly support enables faster cold starts and better resource efficiency for microservices.</p>',
    'https://images.unsplash.com/photo-1667372393119-3d4c48d07fc9?w=800',
    4, 'Kubernetes,Containers,WebAssembly,Cloud Native', 'Emily Rodriguez', TRUE, FALSE, 876, '2026-05-25 08:00:00'
);
...
INSERT INTO news (title, subtitle, summary, content, cover_image, category_id, tags, author, is_published, is_top, view_count, published_at) VALUES (
    ...
    'A comprehensive market analysis predicts the global cloud computing market will surpass $1.5 trillion by 2028, fueled by AI adoption, edge computing expansion, and enterprise digital transformation.',
    '<h2>Market Growth Analysis</h2>
<p>According to a new report from Gartner, the global cloud computing market is on track to reach $1.5 trillion by 2028, representing a CAGR of 18.3% from 2024 levels.</p>
<h3>Key Growth Drivers</h3>
<ul>
<li><strong>AI and ML:</strong> Training and inference workloads account for 35% of new cloud spending</li>
...
<blockquote>The convergence of AI and cloud computing is creating unprecedented demand for scalable infrastructure.</blockquote>',
    ...
    5, 'Cloud Computing,Market Analysis,Digital Transformation', 'Alex Thompson', TRUE, FALSE, 654, '2026-05-24 16:00:00'
);
...
<p>The gap between proprietary and open-source AI models has narrowed dramatically. Recent releases demonstrate that freely available models can perform on par with the best commercial offerings.</p>
...
<p>This democratization means businesses of all sizes can deploy sophisticated AI capabilities without vendor lock-in.</p>',
    'https://images.unsplash.com/photo-1620712943543-bcc4688e7485?w=800',
    2, 'Open Source,LLM,Meta,Mistral,AI Models', 'Sarah Johnson', TRUE, FALSE, 1200, '2026-05-23 10:00:00'
);
...
<p>The 2026 Stack Overflow Developer Survey confirms: Rust has become the premier systems programming language. Its unique combination of performance, memory safety, and developer experience is winning over developers from C and C++.</p>
...
<p>Major tech companies have publicly committed to increasing their use of Rust for critical infrastructure.</p>',
    'https://images.unsplash.com/photo-1515879218367-8466d910a8a3?w=800',
    4, 'Rust,Systems Programming,C++,Developer Survey', 'Emily Rodriguez', TRUE, FALSE, 945, '2026-05-22 13:00:00'
);
...
<p>The landscape of AI-powered development tools has matured significantly. Here are the top tools every developer should consider.</p>
<h3>The Top 10</h3>
<ol>
...
<li><strong>Vercel v0:</strong> Generate UI components from natural language</li>
...
<blockquote>The best developers are those who leverage the best tools to write better code faster.</blockquote>',
    'https://images.unsplash.com/photo-1488590528505-98d2b5aba04b?w=800',
    3, 'Developer Tools,AI,Productivity,Code Generation', 'David Kim', TRUE, FALSE, 1567, '2026-05-21 09:30:00'
);
